...
@Entity
@Table(name = "shortened_working_day")
@Getter
@Setter
@NoArgsConstructor
@ToString
public class ShortenedWorkingDay {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "shortened_working_day_seq")
    @SequenceGenerator(sequenceName = "shortened_working_day_seq", allocationSize = 1, name = "shortened_working_day_seq")
