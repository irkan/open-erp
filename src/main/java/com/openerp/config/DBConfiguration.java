...
public class DBConfiguration {
    ...
    public void run() {
        try{
            ...
            Operation view = new Operation("Baxış", "view", laEye, null);
            operations.add(view);
            Operation create = new Operation("Yarat", "create", laPlus, null);
            operations.add(create);
            Operation edit = new Operation("Redaktə", "edit", laEdit, null);
            operations.add(edit);
            Operation delete = new Operation("Sil", "delete", laTrash, null);
            operations.add(delete);
            Operation export = new Operation("İxrac", "export", laPrint, null);
            operations.add(export);
            Operation approve = new Operation("Təsdiq", "approve", laArchive, null);
            ...
            UserModuleOperation userModuleOperation11 = new UserModuleOperation(user, viewModuleOperation9);
            userModuleOperations.add(userModuleOperation11);
            UserModuleOperation userModuleOperation12 = new UserModuleOperation(user, viewModuleOperation10);
