...
public interface DictionaryRepository extends JpaRepository<Dictionary, Integer> {
    ...
    List<Dictionary> getDictionariesByActiveTrueAndNameAndDictionaryType_Attr1(String name, String attr2);
    ...
    List<Dictionary> getDictionariesByActiveTrueAndDictionaryType_Attr1AndNameStartingWithIgnoreCase(String typeAttr1, String name);
}