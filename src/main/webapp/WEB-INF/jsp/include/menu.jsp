...
<div id="kt_header" class="kt-header  kt-header--fixed " data-ktheader-minimize="on" style="opacity: 0.98; z-index: 10">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active show active"
                                ...
                                <div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll"
                                     data-scroll="true" data-height="400" data-mobile-height="382">
        ...
        <!--end: Language bar -->
            ...
            <div class="kt-header__topbar-item kt-header__topbar-item--quick-panel" data-toggle="kt-tooltip" title="Audit" data-placement="right">
                <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                ...
                <div class="kt-quick-panel__nav">
                    <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand  kt-notification-item-padding-x" role="tablist">
                        <li class="nav-item active">
                            <a class="nav-link active" data-toggle="tab" href="#kt_quick_panel_tab_notifications" role="tab">Audit loqlar</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#kt_quick_panel_tab_logs" role="tab">Xətalar</a>
                        </li>
                    </ul>
                </div>
                <div class="kt-quick-panel__content">
                    <div class="tab-content">
                        <div class="tab-pane fade show kt-scroll active" id="kt_quick_panel_tab_notifications" role="tabpanel">
                            <div class="kt-notification-v2">
                                <c:forEach var="t" items="${sessionScope.logs}" varStatus="loop">
                                    <c:if test="${t.type eq 'info'}">
                                        <a href="#" class="kt-notification-v2__item">
                                            ...
                                            <div class="kt-notification-v2__itek-wrapper">
                                                <div class="kt-notification-v2__item-title">
                                                    <c:out value="${t.tableName}"/> <c:out value="${t.description}"/> <c:out value="${t.operation}"/>
                                                </div>
                                                <div class="kt-notification-v2__item-desc">
                                                    <c:out value="${utl:calculateTime(t.operationDate)}"/>
                                                </div>
                                            </div>
                                        </a>
                                    </c:if>
                            ...
                            <div class="kt-notification-v2">
                                <c:forEach var="t" items="${sessionScope.logs}" varStatus="loop">
                                    <c:if test="${t.type eq 'error'}">
                                        <a href="#" class="kt-notification-v2__item">
                                            <div class="kt-notification-v2__item-icon">
                                                <i class="flaticon2-warning kt-font-danger"></i>
                                            </div>
                                            <div class="kt-notification-v2__itek-wrapper">
                                                <div class="kt-notification-v2__item-title">
                                                    <c:out value="${t.tableName}"/> <c:out value="${t.description}"/> <c:out value="${t.operation}"/>
