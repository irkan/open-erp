        ...
        <div class="accordion  accordion-toggle-arrow mb-2" id="accordionFilter">
            <div class="card" style="border-radius: 4px;">
                ...
                <div id="filterContent" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionFilter">
                    <div class="card-body">
                        <form:form modelAttribute="filter" id="filter" method="post" action="/hr/illness/filter">
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form:form modelAttribute="form" id="form" method="post" action="/hr/illness" cssClass="form-group">
                    <form:hidden path="id"/>
                    <form:hidden path="organization.id" />
                    <div class="form-group">
                        <form:label path="employee.id">Əməkdaş</form:label>
